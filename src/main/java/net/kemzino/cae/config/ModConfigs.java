...
//_______________CONFIG_VALUES_END
    ...
    private static void createConfigs() {
        ...
        configs.addKeyValuePair(new Pair<>("netherite.anvil.lvl.modification", 0.5), "double / netherite anvil ask less exp");
    ...
    private static void assignConfigs() {
        ...
        NETHERITE_ANVIL_LVL_MODIFICATION = CONFIG.getOrDefault("netherite.anvil.lvl.modification", 0.5);
